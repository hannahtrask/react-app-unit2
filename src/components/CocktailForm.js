	...
	return (
		<div>
			<div className='desktop'>
				...
				<p>
					A resource for inspiration. Type in anything— want a margarita but not
					sure what spin to put on it? Not sure what you want to drink but know
					it has a 'B' somewhere in the name? Type anything below and we'll find
